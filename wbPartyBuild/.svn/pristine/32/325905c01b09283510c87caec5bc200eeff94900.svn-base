 	...
 	<div class="Hui-article" >
		<div class="page-container">
				...
				<div class="t_searchbar">
					<form action="<%=path %>/generalStatisticsController/exportExcel.do" id="exportForm">
				...
				<div class="t_ctrlbar"> 
					 <span class="btns">
					   	<m:a_top context="导出"  operCode="exportGeneralStat"  funMethod="exportExcel()" className="btn btn-primary radius" />
					 </span> 
				...
				<table id="generalStat_table" class="table table-border table-bordered table-hover table-bg table-sort">			
				</table>
		...
		<script type="text/javascript" src="<%=path %>/plug-in/web/scripts/portals/generalStat/generalStat-list.js"></script>
