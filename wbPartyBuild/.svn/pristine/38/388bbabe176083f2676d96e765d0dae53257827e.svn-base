...
<body>
	...
	<div class="Hui-article">
		<div class="page-container">
			<div class="t_searchbar">
				登录时间： <input style="width:120px" type="text" id="beginTime"
				...
				<!-- ==========END OF department tree========== -->
				<button type="button" class="btn btn-danger" onclick="goSearch()">
	...
	<!-- ==========END OF department tree========== -->
	<script type="text/javascript"
		src="<%=path%>/plug-in/web/scripts/system/count/loginFrequency-list.js"></script>
</body>
</html>
