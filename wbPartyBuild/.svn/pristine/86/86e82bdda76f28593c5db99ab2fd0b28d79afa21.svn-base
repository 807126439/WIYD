 var mtable;
		 $(function(){
			 ...
			 mtable = $("#content_table").dataTable({
				    "sAjaxSource": path+"/contentController/pageList.do",
				    "sServerMethod":"post",
				    ...
				    "aoColumns": [
				    			   { "mDataProp":"ctId" , "sClass": "text-c","width":"32px","bSortable": false,"sTitle": "<input type=\"checkbox\" name=\"\" value=\"\" >",
	                               ...
	                               { "sTitle": "来源", "sClass": "center","mDataProp":"source","width":"100px"},  
	                               { "sTitle": "作者", "sClass": "center","mDataProp":"author","width":"100px"},  
	                                              ...
	                                              
	                               {
	                                   ...
	                                   "mRender": function (data, type, full) {
	                                		...
	                                		var html = "<div class=\"t-btn-container\">";                             		
		                              		...
		                              		if(typeof(move_content)!= "undefined"){
		                              			 if(move_content.length>0){
		                              			 	html+=move_content.format(data);
		                              			 }                            			
		                              		}
