	...
	<div class="Hui-article"
		...
		<div class="pd-20">
			...
			<div style="display:inline-block;">
				<a class="btn btn-primary radius" style="margin: 8px;"
					onclick="subStudyDataChoice()" href="javascript:;"> 确定</a>
			</div>
			<div class="item-contrl" style="display:inline-block;">
				<span class="checksAll"> <a href="javascript:selectAll()"
					class="selectAll">全选</a>|<a href="javascript:cancelAll()"
					class="cancelAll">全不选</a>
				</span>
			</div>
			<!-- ==========缩略图列表========== -->
