...
<html>
  ...
  <body>
	<div class="pd-20">
	  <form action="<%=path %>/feelingRecordController/editFeelingRecord.do" method="post" class="form form-horizontal" id="form-editFeelingRecord" >
	  <input type="hidden" value="${result.id}" name="id"/>
		<div class="row cl">
			<label class="form-label col-xs-2 col-sm-2"><span class="c-red">*</span>标题：</label>
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" class="input-text"  name="title"  datatype="*2-80" value="${result.title}" nullmsg="议题不能为空">
			</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-8" > 
				<script id="editor" type="text/plain" style="width:100%;height:300px;">${result.content}</script> 
			</div>
		</div>
		
	  	 <div class="row cl">
	      <div class="col-xs-offset-3 col-sm-offset-5" style="margin-left:42%;">
    ...
    <script type="text/javascript" src="<%=path %>/plug-in/web/scripts/portals/FeelingRecord/feelingRecord-edit.js"></script> 
</body>
