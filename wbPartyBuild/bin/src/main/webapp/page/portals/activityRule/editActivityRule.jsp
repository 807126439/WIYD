...
<html>
  ...
  <body>
	<div class="pd-20">
	 <form action="<%=path %>/activityRuleController/editActivityRule.do" method="post" class="form form-horizontal" id="form-activityRule-edit" >       
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-7 col-sm-2">
				<input type="text" class="input-text"  name="num"  nullmsg="排序不能为空" value="${result.num}">
			</div>
			...
			<div class="formControls col-xs-1 skin-minimal">
				<div class="check-box">
					<input type="checkbox"  value="true"  name="isMain" ${result.isMain eq true ? 'checked="checked"':''}>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-8" style="width:650px;"> 
				<script id="editor" type="text/plain" style="width:100%;height:270px;">${result.content}</script> 
			</div>
		</div>	
	    ...
	    <div class="row cl">
	      <div class="col-xs-2 col-xs-offset-3 col-sm-offset-5" >
	         <m:b_button operCode="editActivityRule" type="submit" value="&nbsp;&nbsp;提交&nbsp;&nbsp;" />
	      </div>
	    </div>
    ...
    <script type="text/javascript" src="<%=path %>/plug-in/web/scripts/portals/activityRule/activityRule-edit.js"></script>
