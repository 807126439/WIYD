...
<div class="row cl">
	 ...
	 <!--  
	   ...
	   <div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-2 col-sm-2">置于手机端首页：</label>
			<div class="formControls col-xs-8 col-sm-8 skin-minimal">
				<div class="check-box">
					<input type="checkbox" id="appStatus" name="appStatus" value="1" ${contentItem.appStatus eq 1? 'checked="checked"':'' } >
					<label for="checkbox-pinglun">&nbsp;</label>
				</div>
			</div>
			<div class="col-xs-2 col-sm-2"></div>
