 var mtable;
		 $(function(){	
			 ...
			 mtable = $("#studyTask_table").dataTable({
				 "sAjaxSource": path+"/studyTaskController/pageList.do",
				  "sServerMethod":"post",
		           ...
		           // "sScrollY": "500px",
				    ...
				    "aoColumns": [
				    			   { "mDataProp":"stId" ,"bSortable": false,
				    			   ...
				    			   { "sTitle": "开始时间", "sClass": "center","mDataProp":"startTime" },
				    			   { "sTitle": "任务编号", "sClass": "center","mDataProp":"taskNum" },   			
	                               { "sTitle": "任务名称", "sClass": "center","mDataProp":"taskName" }, 
	                               { "sTitle": "试卷名称", "sClass": "center","mDataProp":"paperName" }, 
	                               { "sTitle": "结束时间", "sClass": "center","mDataProp":"endTime" },  
	                               { "sTitle": "操作","sClass": "center",  "mDataProp":"stId","bSortable": false,
	                            	   "mRender": function (data, type, full) {
	     	                              
	                              			var html = "";                             		
		                              		if(typeof(update_StudyTask)!= "undefined"){
		                              			 if(update_StudyTask.length>0){ 
		                              			 	html+=update_StudyTask.format(full.stId);
		                              			 };                            			
		                              		}
		                              		if(typeof(delete_StudyTask)!= "undefined"){
		                              			 if(delete_StudyTask.length>0){
		                              			 	html+=delete_StudyTask.format(full.stId);
		                              			 };                            			
		                              		}
		                              		return html;
	                                   }
	              ...
	              "fnServerParams" : function (aoData) {
						aoData.push(
						{ "name": "taskNum", "value": $("#taskNum").val() },
