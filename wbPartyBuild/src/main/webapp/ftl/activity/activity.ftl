		      	  ...
		      	  <div class="mod-content">
			          <ul id="announcementlist"> 
			            <#if result.contentList??>
							<#list result.contentList as k1>
				     			 <li class="announcement" title="${k1.title!}">
					              <div class="announcementaside">
					                <span class="publicdate">${k1.time!}</span>
					              </div>
					             
					              <a href="${path}/article/${k1.id}.htm" class="announcementcontent"> 
					              <#if k1.indexFlag=1>
