  ...
  <body>
	<div class="pd-20">
	  <form action="<%=path %>/banChunkController/addBanChunk.do" method="post" class="form form-horizontal" id="form-department">
	   ...
	   <%@include file="/page/portals/banChunk/common/editItem.jsp" %>
	...
	<script type="text/javascript" src="<%=path%>/plug-in/web/scripts/portals/banChunk/banChunk-add.js"></script> 
