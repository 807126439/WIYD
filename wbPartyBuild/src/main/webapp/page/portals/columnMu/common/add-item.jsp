 	...
 	<div class="row cl">
	      ...
	      <div class="formControls col-xs-6 col-sm-6">
	     	<span class="select-box" >
				<select id="choice-par" class="select" name="parentId" >
	    ...
	    <div class="row cl">
			...
			<div class="formControls col-xs-1 col-sm-1 skin-minimal">
				<div class="check-box">
					<input type="checkbox" id="checkbox-is-indexNav" value="true"  name="isIndexNav"  ${colMuItem.isIndexNav eq true? 'checked="checked"':''} >
					<label for="checkbox-is_index">&nbsp;</label>
				</div>
			...
			<label class="form-label col-xs-3 col-sm-3">忽略上级显示类型：</label>
