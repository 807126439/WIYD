...
<body>
	<div class="pd-20" style="text-align: center;">
		<form action="<%=path%>/examPaperController/editExamPaper.do" method="post" class="form form-horizontal" id="form-examPaper-edit">
			<input type="hidden" name="id" value="${result.id}">
			<input type="hidden" name="paperType" value="${result.paperType}">
			...
			<div class="row cl" style="margin-top: 20px;">
				...
				<div class="formControls col-xs-3 col-sm-2">
					<input type="text" class="input-text" name="examMinute"  datatype="n" nullmsg="请填写考试时间" style="width:70%;margin-right:2px" value="${result.examMinute}">分钟
				</div>
			</div>
				...
				<div class="row cl" style="margin-top: 20px;">
					...
					<div class="formControls col-xs-2 col-sm-2">
						<input type="text" class="input-text" name="singleNum"  datatype="n" ignore="ignore" value="${result.singleNum}">
					</div>
					
					<label class="form-label col-xs-3 col-sm-2">多选题数目：</label>
					<div class="formControls col-xs-2 col-sm-2">
						<input type="text" class="input-text" name="multiNum"  datatype="n" ignore="ignore" value="${result.multiNum}">
					</div>
				...
				<div class="row cl" style="margin-top: 20px;">
					...
					<div class="formControls col-xs-2 col-sm-2">
						<input type="text" class="input-text" name="blankNum"  datatype="n" ignore="ignore" value="${result.blankNum}">
					</div>
				
					<label class="form-label col-xs-3 col-sm-2">判断题数目：</label>
					<div class="formControls col-xs-2 col-sm-2">
						<input type="text" class="input-text" name="judgeNum"  datatype="n" ignore="ignore" value="${result.judgeNum}">
					</div>
	...
	<script type="text/javascript" src="<%=path%>/plug-in/web/scripts/study/examPaper/editExamPaperR.js"></script>
