...
<body>
	<div class="pd-20">
		<form action="<%=path%>/studyTaskController/editStudyTask.do"
	...
	<%--@include file="/page/study/studydata/common/edit-item.jsp"--%>
	...
	<%-- <script type="text/javascript" src="<%=path%>/plug-in/web/scripts/study/studyData/common/stuData-list.js"></script> --%>
	<script type="text/javascript"
