var mtable;
		$(function(){
			...
			mtable = $("#auth_table").dataTable({
			    "sAjaxSource": path+"/authController/pageList.do",
			    "sServerMethod":"post",
			    ...
			    "aoColumns": [
                               ...
                               { "sTitle": "权限名", "sClass": "center","mDataProp":"authText" },                     
                               { "sTitle": "权限码", "sClass": "center","mDataProp":"authCode" },
                               ...
                               { "sTitle": "状态",
                                ...
                                "mRender": function (data, type, full) {
                            		   if(data == 0){
                             		  	  return "<span class=\"label label-defaunty radius\">普通</span>";
                             		   }else if(data == 1){
                             		      return "<span class=\"label label-primary radius\">前台控制</span>";                            		                              		   
                             		   }else{
                             		    return "";
                             		  }	
                                 }
                                 ...
                                 "mDataProp":"authType",
                                  "mRender": function (data, type, full) {                                                              	                             	                             	
                                       if(data == 0){
                             		      ...
                             		      return "<span class=\"label label-default radius\">访问</span>";                            		                              		   
                             		   }else if(data == 2){
                               ...
                               { "sTitle": "排序", "sClass": "center" ,"mDataProp":"authOrder"},                         
                               { "sTitle": "图案", "sClass": "center","mDataProp":"icon", "bSortable": false,
                               	    "mRender": function (data, type, full) {
                               ...
                               { "sTitle": "父节点", "sClass": "center","mDataProp":"parentName" },  
	...
	function auth_edit(title,id,w,h){
	     var url = path+"/authController.do?detail&aid="+id;
		layer_show(title,url,w,h);
	}
