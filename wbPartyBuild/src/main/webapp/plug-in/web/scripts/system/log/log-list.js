var mtable;
		$(function(){
			...
			mtable = $("#log_table").dataTable({
			    "sAjaxSource": path+"/loginLogController/pageList.do",
			    "sServerMethod":"post",
			    ...
			    "aoColumns": [
                               ...
                               { "sTitle": "登录时间", "sClass": "center","mDataProp":"loginDate" },
            ...
            "fnServerParams" : function (aoData) {
					aoData.push(
					{ "name": "beginTime", "value": $("#datemin").val() },
